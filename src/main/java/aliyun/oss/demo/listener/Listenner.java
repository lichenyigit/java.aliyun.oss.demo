package aliyun.oss.demo.listener;

import aliyun.oss.demo.exception.JsonConvertFailedException;
import aliyun.oss.demo.util.JsonUtil;
import aliyun.oss.demo.util.Result;
...
public class Listenner implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce){
		...
		try {
			...
			templateCfg.setSharedVariable("contextPath", getJndiString("asia.tokaji.web.contextPath"));
		} catch (TemplateModelException e) {
			e.printStackTrace();
		}
		
		logger.info("阿里云OSS上传服务初始化成功.");
	}
